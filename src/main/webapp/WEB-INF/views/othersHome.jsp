...
<table border='1'>
	...
	<c:forEach var="complaints" items="${complaints}">
		<form:form action="showmessages.htm" method="POST">
		<input type="hidden" name="messageID" value="${complaints.reportID}"/> 			
		<tr> <td>${complaints.reportDesc}</td><td>Anonymous</td><td>${complaints.report}</td><td><input type="submit" value="View" /></td></tr>
		</form:form>
	</c:forEach>
</table>
</body>
